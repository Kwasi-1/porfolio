...
const Sidebar = () => {
  ...
  return (
    // <div className='h-screen flex '>
      <div className="flex flex-col justify-between h-screen items-center w-[6%] pt-[5%] pb-10 font-body tracking-[5px] text-[10px] font-[500]">
        ...
        <div className='flex flex-col items-center space-y-10 tracking-[5px] '>
          ...
          {isHomePage ? (
            <div className="flex flex-col space-y-10 mt-4 text-center items-center">
              <a href="#" className="text-xs hover:line-through -rotate-90">DR</a>
              <a href="#" className="text-xs hover:line-through -rotate-90">TW</a>
              <a href="#" className="text-xs hover:line-through -rotate-90">LI</a>
            </div> 
            ) : (
